...
class TestPolDur():
    ...
    def test_pol_yr_1(self):
        assert pol_yr("2024-03-14", "2023-03-15")[0] == 1

    def test_pol_yr_2(self):
        assert pol_yr("2024-03-15", "2023-03-15")[0] == 2

    def test_pol_qtr_1(self):
        assert pol_qtr("2023-06-14", "2023-03-15")[0] == 1

    def test_pol_qtr_2(self):
        assert pol_qtr("2023-06-15", "2023-03-15")[0] == 2

    def test_pol_mth_1(self):
        assert pol_mth("2023-04-14", "2023-03-15")[0] == 1

    def test_pol_mth_2(self):
        assert pol_mth("2023-04-15", "2023-03-15")[0] == 2

    def test_pol_wk_1(self):
        assert pol_wk("2023-03-21", "2023-03-15")[0] == 1

    def test_pol_wk_2(self):
        assert pol_wk("2023-03-22", "2023-03-15")[0] == 2
...
class TestLeapYear():
    ...
    def test_leap_iss_1(self):
        assert pol_yr("2021-02-27", "2020-02-29")[0] == 1

    def test_leap_iss_2(self):
        assert pol_yr("2021-02-28", "2020-02-29")[0] == 2

    def test_leap_iss_3(self):
        assert pol_mth("2020-03-28", "2020-02-29")[0] == 1

    def test_leap_iss_4(self):
        assert pol_mth("2020-03-29", "2020-02-29")[0] == 2

    def test_228_iss_1(self):
        assert pol_yr("2024-02-27", "2023-02-28")[0] == 1

    def test_228_iss_2(self):
        assert pol_yr("2024-02-29", "2023-02-28")[0] == 2
